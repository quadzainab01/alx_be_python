...
def display_menu():				# Function to display the main menu options to the user
...
def main(): 						# Main function containing the program logic
    ...
    while True:  					# Start an infinite loop to keep the program running until user exits
        ...
        if choice == '1':          					# User chose to add an item
	...
	elif choice == '2':					     	 	# User chose to remove an item
        ...
        elif choice == '3':			        			# User chose to view the shopping list
